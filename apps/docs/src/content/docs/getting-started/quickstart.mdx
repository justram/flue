...
Open an interactive console for the discovered agent:

```bash
npx flue console hello-world
```

The console starts your configured Node.js or Cloudflare runtime, displays the generated agent-instance ID, and waits for your first message. Type a prompt and press Enter; follow-up prompts continue on the same instance until you exit.
